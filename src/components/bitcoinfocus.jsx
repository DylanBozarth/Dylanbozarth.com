...
export const Bitcoin = ({ match }) => (
  <motion.div className="single" initial="exit" animate="enter" exit="exit">
     ...
     <a href="https://reverent-galileo-db7978.netlify.app/" target="_blank" rel="noopener noreferrer"> <motion.img
    ...
    <div className="linkbox">
     ...
     A quick and easy way to track the prices of the 3 most popular cryptocurrencies. Built with React hooks and SCSS.   <br /> 
