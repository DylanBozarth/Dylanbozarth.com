...
export const AndromedaFocus = ({ match }) => (
    <motion.div className="single" initial="exit" animate="enter" exit="exit">
        ...
        <motion.div className="back" variants={backVariants}>
          ...
          <div className="row">
            <img width="50px" height="50px" alt="icon" src='./images/icons/typescript.png'></img>
       ...
       <a href="https://andromedagame.online/" target="_blank" rel="noopener noreferrer"> <motion.img
      ...
      <div className="linkbox">
        ...
        <p className="focustext">
            I am currently leading a team to create the first always online 4x strategy game. 
        </p>
      </div>
    </motion.div>
  );
