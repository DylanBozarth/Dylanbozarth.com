  ...
  >
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-sm ">
          <aside className="profile-card asidereact">
            ...
            <div className="profile-bio">
              <p>React</p>
              <p>React (also known as React.js or ReactJS) is an open-source JavaScript library for building user interfaces. It is maintained by Facebook and a community of individual developers and companies.</p>
            </div>
          </aside>{" "}
      ...
      <div className="row">
        ...
        <div className="col-sm ">
          <aside className="profile-card asidescss">
            ...
            <div className="profile-bio">
              <p>SCSS</p>
              <p>Sass (short for syntactically awesome style sheets) is a style sheet language. Used for advanced styling of web applications. </p>
            </div>
          </aside>{" "}
        ...
        <div className="col-sm ">
          <aside className="profile-card asideredux">
            ...
            <div className="profile-bio">
              <p>Redux</p>
              <p>Redux is an open-source JavaScript library for managing application state. It is most commonly used with libraries such as React or Angular for building user interfaces. Similar to (and inspired by) Facebook's Flux architecture</p>
            </div>
          </aside>{" "}
      ...
      <div className="row linkboxes">
        ...
        <a className="evidencelink" target="_blank"
        rel="noopener noreferrer" href="https://github.com/Imstupidpleasehelp">
        ...
        <div className="col-sm evidencelink">
        <a className="evidencelink" target="_blank"
        rel="noopener noreferrer" href="https://codepen.io/dashboard/?cursor=ZD0wJm89MSZwPTEmdj00MTU1NTkyMg==">
        <div className="col-md-4">Codepen
          <div className="skillboximgcodepen"></div> <br />
          
        </div></a></div>
        <div className="col-sm evidencelink">
        <a className="evidencelink" target="_blank"
        rel="noopener noreferrer" href="https://www.freecodecamp.org/dylanbozarth">
        <div className="col-md-4">Freecodecamp
          {" "}
          <div className="skillboximgfcc"></div>
          <br />
